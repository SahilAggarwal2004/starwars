...
export const getPlayers = () => [
  ...
  new Player({
    ...
    special: {
      damage: randomNumber(125, 150),
      description: "Heal all allies by 10% of his current health and grant all allies defense up for 1 turn.",
      cooldown: 2,
      animation: true,
      foresight: true,
      auto: true,
  ...
  new Player({
    ...
    basic: {
      ...
      description: "This attack has a 20% chance to revive a random defeated ally at 100% of his initial health.",
      animation: true,
      auto: true,
    },
    ...
    unique: {
      description: "This player has 100% counter chance and recovers 5% of his initial health whenever this player counters an attack. He takes 20% less damage from any attack.",
      type: "after",
    },
  }),
  new Player({
  ...
  new Player({
    ...
    special: { description: "Inflict 2 damage over turn effects and speed down on all enemies for 1 turn.", cooldown: 1, foresight: true },
  ...
  new Player({
    ...
    leader: {
      description: "Whenever a light side ally uses a special ability, it will gain foresight for 2 turns. If Hermit Yoda is an ally, he gains 5% turn meter.",
      type: "in-game",
      foresight: true,
    },
  }),
  new Player({
    ...
    basic: {
      damage: randomNumber(60, 100),
      description: "This attack has an 25% chance to deal double damage. If the leader is Grand Master Yoda, Hermit Yoda gains foresight for 1 turn.",
      animation: true,
      foresight: true,
    },
    special: {
      damage: randomNumber(125, 150),
      description: "Call all the light side allies to assist dealing 50% less damage.",
      cooldown: 2,
      animation: true,
      foresight: true,
      auto: true,
    ...
    unique: {
      description: "He gains 5% turn meter whenever he is attacked, excluding counter attacks. If Grand Master Yoda is an ally, he also gains 5% turn meter.",
      type: "succeeding",
    },
  }),
  new Player({
    ...
    special: {
      ...
      description: "Call another random ally to assist and increase speed of this player by 10.",
      cooldown: 1,
      animation: true,
      foresight: true,
      auto: true,
  ...
  new Player({
    ...
    special: {
      damage: randomNumber(125, 150),
      description: "Reset the cooldowns of light side allies to 0 and decrease speed of dark side enemies by 5.",
      cooldown: 2,
      animation: true,
      foresight: true,
      auto: true,
  ...
  new Player({
    ...
    special: {
      damage: randomNumber(25, 60),
      description: "Heal all allies by 20% of her current health and deal special damage to all enemies and double damage to target enemy.",
      cooldown: 2,
      animation: true,
      foresight: true,
    },
...
export const leaderAbilities = {
  ...
  "Darth Vader": ({ allyTeam }) =>
    allyTeam.forEach(({ type }, i) => {
      if (type === "dark") allyTeam[i].speed += 10;
    }),
  "Jolee Bindo": ({ allyTeam }) => indexes.forEach((index) => (allyTeam[index].health *= 1.25)),
  "Mother Talzin": ({ allyTeam }) =>
    allyTeam.forEach(({ type }, index) => {
      if (type == "dark") allyTeam[index].health *= 1.4;
    }),
};
