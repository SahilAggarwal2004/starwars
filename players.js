...
const F = {
    ...
    leader: { description: "Whenever an ally uses a basic ability decrease the cooldown of his special ability by 1." }
}
const G = {
...
const J = {
    ...
    basic: { damage: random(50, 100) },
    special: { damage: random(100, 150), description: 'Call another random ally to assist and increase speed of this player by 2.', cooldown: 1 }, stun: false,
