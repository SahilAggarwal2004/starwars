...
const A = {
    name: 'Bastila Shan', health: random(350, 550), type: 'Dark',
    basic: {
        damage: random(50, 80),
...
const B = {
    name: 'Jolee Bindo', health: random(350, 550), type: 'Light',
...
const C = {
    name: 'Darth Vader', health: random(350, 550), type: 'Dark',
...
const D = {
    name: 'Old Daka', health: random(350, 550), type: 'Dark',
    basic: { damage: random(50, 100) },
...
const E = {
    name: 'Chewbecca', health: random(700, 1100), type: 'Light',
...
const I = {
    name: 'Mother Talzin', health: random(350, 550), type: 'Dark',
...
const J = {
    name: 'Jedi Consular', health: random(350, 550), type: 'Light',
    basic: { damage: random(50, 100) },
    special: { damage: random(100, 150), description: 'Call another random ally to assist and increase speed of this player  and assisted ally by 2.', cooldown: 1 },
