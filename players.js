...
const players = [
    new Player({
        ...
        special: { damage: randomNumber(100, 150), description: 'Stun the opponent and inflict buff immunity for 1 turn.', cooldown: 1, animation: true, foresight: false },
    ...
    new Player({
        ...
        basic: { damage: randomNumber(60, 100), description: "This attack has a 25% chance to revive a random defeated ally at 100% of his initial health.", animation: true, foresight: false },
        special: { description: 'Inflict defense down on target enemy for 2 turns and other enemies for 1 turn', cooldown: 1, animation: false, foresight: true },
    ...
    new Player({
        ...
        unique: { description: 'Whenever an enemy attacks Darth Vader, he inflicts damage over turn on that enemy for 1 turn.', type: 'after', foresight: false }
    }),
    new Player({
    ...
    new Player({
        ...
        basic: { damage: randomNumber(60, 100), description: "Light side allies gain 50 health.", animation: true, foresight: true },
