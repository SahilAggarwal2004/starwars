...
const players = [
    {
        name: 'Bastila Shan', health: randomNumber(350, 500), type: 'Light', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
        basic: {
    ...
    {
        name: 'Jolee Bindo', health: randomNumber(350, 500), type: 'Light', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Darth Vader', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
        basic: { damage: randomNumber(75, 120) },
    ...
    {
        name: 'Old Daka', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
        basic: { damage: randomNumber(75, 120) },
    ...
    {
        name: 'Chewbecca', health: randomNumber(700, 1000), type: 'Light', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Jedi Knight Revan', health: randomNumber(350, 500), type: 'Light', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Darth Revan', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Count Dooku', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 0.8,
    ...
    {
        name: 'Mother Talzin', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Jedi Consular', health: randomNumber(350, 500), type: 'Light', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
        basic: { damage: randomNumber(75, 120) },
    ...
    {
        name: 'Darth Nihilus', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
    ...
    {
        name: 'Grand Master Yoda', health: randomNumber(350, 500), type: 'Dark', speed: randomNumber(10, 15), stun: false, foresight: 0, multiplier: 1,
        basic: { damage: randomNumber(60, 100), description: 'Gains foresight for 1 turn.' },
        special: { damage: randomNumber(60, 100), description: 'Grant foresight to all allies for 1 turn.', cooldown: 2 }
    }
]
